...
// Facebook allocates and returns a new AuthHandler, using the FacebookProvider.
func Facebook(key, secret, redirect string) *AuthHandler {
	return New(NewFacebookProvider(key, secret, redirect))
}
